			...
			<div id='memberships' className='margin'>
				<section className={styles['pricing']}>
					...
					<p>
						...
						exceptional circumstance which will be decided by Finquest on a case to case basis <br />
						<br />
						<b>3.</b> Finquest does not store any of your payment information (debit card, credit card, net
						...
						by case basis and Finquest&apos;s decision will be final and binding. <br />
						<br />
						<b>4.</b> For any concerns related to payment or refunds, kindly write to
						hellofinquest@gmail.com <br />
						<br />
					</p>
					<br />
					<br />
