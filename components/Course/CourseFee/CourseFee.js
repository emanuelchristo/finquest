    ...
    <>
      <div className="margin">
        <div className="bg-lightblue rounded-3xl  p-16 lg:p-8 relative ">
          <div className=" grid grid-cols-2 grid-rows-2 justify-center items-center md:grid-cols-1 md:grid-rows-3">
            ...
            <div className="grid grid-cols-2 lg:grid-cols-1 md:grid-cols-2 ">
              <div>
                <h3 className="font-semibold text-2xl">4 Months</h3>
                <p>Duration</p>
              </div>
              <div>
                <h3 className="font-semibold text-2xl whitespace-nowrap">EMI Available</h3>
                <p>Contact us</p>
              </div>
            </div>
            <div className="grid grid-rows-3">
              ...
              <h3 className="text-4xl font-semibold">(Including GST)</h3>
              <p>Total price</p>
            </div>
          </div>
          <img
          ...
          <img
            ...
            width={125}
            height={162}
            className="absolute bottom-0 rotate-180 left-72"
          />
        </div>
      </div>
    </>
